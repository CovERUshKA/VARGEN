...
public:
	...
	constexpr void setDrawColor(float color[4]) noexcept
	{
		callVirtualMethod<void, int, int, int, int>(this, 15, static_cast<int>(color[0] * 255), static_cast<int>(color[1] * 255), static_cast<int>(color[2] * 255), static_cast<int>(color[3] * 255));
	}
	...
	constexpr void setTextColor(float color[4]) noexcept
	{
		callVirtualMethod<void, int, int, int, int>(this, 25, static_cast<int>(color[0] * 255), static_cast<int>(color[1] * 255), static_cast<int>(color[2] * 255), static_cast<int>(color[3] * 255));
	}
	...
	constexpr void printText(const wchar_t* text, int drawType = 0) noexcept
	{
		callVirtualMethod<void, const wchar_t*, int, int>(this, 28, text, wcslen(text), drawType);
	}
