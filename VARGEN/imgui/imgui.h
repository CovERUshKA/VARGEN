...
namespace ImGui
{
	...
	IMGUI_API bool			ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags); // button
    ...
    IMGUI_API bool          ColorEdit4(const char* label, float col[4], ImGuiColorEditFlags flags = 0, ImGuiColorEditFlags colorpickflags = 0);
